...
<i class="bi bi-plus-square"></i> <div>Create</div> 
</span>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button class="my-2 rounded-3 border-0 w-100 text-white fw-medium" style="background: linear-gradient(red,purple,orange) ">Upload</button>
        </form>
      </div>
    </div>
  </div>
